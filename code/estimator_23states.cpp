...
void AttPosEKF::FuseRangeFinder()
{
    ...
    if (useRangeFinder && fuseRngData && cosRngTilt > 0.87f)
    {
        ...
        //printf("ptd=%5.1f, pd=%5.1f, innov=%5.1f\n", ptd, pd, innovRng);
...
void AttPosEKF::FuseOptFlow()
{
    ...
    if (validTilt && validHeight)
    {
        ...
        if (fuseOptFlowData)
        {
            ...
            K_LOS[0][0] = -(P[0][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[0][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[0][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[0][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[0][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[0][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[0][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[0][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[0][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8])/(R_LOS + (SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8])*(P[0][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][0]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) + P[2][0]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][0]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) - P[4][0]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][0]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][0]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][0]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][0]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]) + (SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8])*(P[0][1]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) + P[2][1]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][1]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) - P[4][1]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][1]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][1]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][1]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][1]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]) + (SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8])*(P[0][2]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][2]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) + P[2][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][2]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) - P[4][2]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][2]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][2]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][2]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][2]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]) - (SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8])*(P[0][3]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][3]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) + P[2][3]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) - P[4][3]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][3]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][3]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][3]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][3]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]) - SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2)*(P[0][4]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][4]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) + P[2][4]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][4]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) - P[4][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][4]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][4]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][4]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]) + SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3)*(P[0][6]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][6]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) + P[2][6]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][6]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) - P[4][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][6]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][6]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][6]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]) - SH_LOS[0]*SH_LOS[2]*SH_LOS[4]*(P[0][9]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][9]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) + P[2][9]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][9]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) - P[4][9]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][9]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][9]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]) + SH_LOS[0]*SH_LOS[2]*SH_LOS[4]*(P[0][22]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][22]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) + P[2][22]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][22]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) - P[4][22]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][22]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][22]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]) + SH_LOS[0]*SK_LOS[6]*SK_LOS[8]*(P[0][5]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][5]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) + P[2][5]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][5]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) - P[4][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][5]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][5]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]));
            K_LOS[0][1] = -SK_LOS[1]*(P[1][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[1][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[1][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[1][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[1][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[1][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[1][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[1][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[1][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][2] = -SK_LOS[1]*(P[2][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[2][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[2][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[2][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[2][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[2][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[2][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[2][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[2][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][3] = -SK_LOS[1]*(P[3][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[3][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[3][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[3][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[3][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[3][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[3][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[3][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[3][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][4] = -SK_LOS[1]*(P[4][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[4][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[4][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[4][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[4][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[4][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[4][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[4][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[4][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][5] = -SK_LOS[1]*(P[5][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[5][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[5][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[5][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[5][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[5][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[5][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[5][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][6] = -SK_LOS[1]*(P[6][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[6][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[6][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[6][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[6][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[6][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[6][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[6][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[6][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][7] = -SK_LOS[1]*(P[7][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[7][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[7][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[7][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[7][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[7][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[7][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[7][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[7][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][8] = -SK_LOS[1]*(P[8][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[8][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[8][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[8][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[8][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[8][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[8][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[8][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[8][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][9] = -SK_LOS[1]*(P[9][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[9][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[9][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[9][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[9][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[9][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[9][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[9][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[9][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][10] = -SK_LOS[1]*(P[10][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[10][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[10][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[10][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[10][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[10][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[10][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[10][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[10][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][11] = -SK_LOS[1]*(P[11][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[11][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[11][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[11][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[11][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[11][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[11][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[11][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[11][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][12] = -SK_LOS[1]*(P[12][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[12][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[12][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[12][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[12][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[12][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[12][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[12][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[12][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][13] = -SK_LOS[1]*(P[13][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[13][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[13][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[13][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[13][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[13][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[13][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[13][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[13][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][14] = -SK_LOS[1]*(P[14][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[14][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[14][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[14][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[14][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[14][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[14][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[14][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[14][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][15] = -SK_LOS[1]*(P[15][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[15][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[15][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[15][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[15][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[15][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[15][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[15][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[15][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][16] = -SK_LOS[1]*(P[16][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[16][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[16][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[16][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[16][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[16][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[16][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[16][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[16][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][17] = -SK_LOS[1]*(P[17][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[17][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[17][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[17][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[17][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[17][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[17][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[17][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[17][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][18] = -SK_LOS[1]*(P[18][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[18][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[18][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[18][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[18][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[18][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[18][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[18][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[18][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][19] = -SK_LOS[1]*(P[19][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[19][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[19][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[19][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[19][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[19][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[19][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[19][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[19][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][20] = -SK_LOS[1]*(P[20][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[20][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[20][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[20][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[20][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[20][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[20][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[20][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[20][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            K_LOS[0][21] = -SK_LOS[1]*(P[21][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[21][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[21][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[21][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[21][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[21][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[21][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[21][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[21][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            if (!inhibitGndHgtState) {
                K_LOS[0][22] = -SK_LOS[1]*(P[22][0]*(SK_LOS[4] + 2*q0*SH_LOS[2]*SK_LOS[8]) + P[22][1]*(SK_LOS[3] - 2*q1*SH_LOS[2]*SK_LOS[8]) - P[22][3]*(SK_LOS[2] - 2*q3*SH_LOS[2]*SK_LOS[8]) + P[22][2]*(SK_LOS[5] - 2*q2*SH_LOS[2]*SK_LOS[8]) - P[22][4]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 - 2*q1*q2) + P[22][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q1 + 2*q2*q3) - P[22][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[4] + P[22][5]*SH_LOS[0]*SK_LOS[6]*SK_LOS[8]);
            } else {
                K_LOS[0][22] = 0.0f;
            }
            ...
            //printf("losPred.x=%5.3f, flowRadXYcomp.x=%5.3f\n", losPred[0], flowRadXYcomp[0]);
            ...
            H_LOS[1][9] = -SH_LOS[0]*SH_LOS[1]*SH_LOS[4];
            H_LOS[1][22] = SH_LOS[0]*SH_LOS[1]*SH_LOS[4];

            // Calculate Kalman gains for Y LOS rate
            K_LOS[1][0] = SK_LOS[0]*(P[0][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[0][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[0][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[0][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[0][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[0][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[0][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[0][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[0][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][1] = SK_LOS[0]*(P[1][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[1][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[1][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[1][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[1][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[1][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[1][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[1][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[1][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][2] = SK_LOS[0]*(P[2][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[2][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[2][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[2][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[2][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[2][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[2][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[2][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[2][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][3] = SK_LOS[0]*(P[3][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[3][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[3][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[3][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[3][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[3][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[3][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[3][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[3][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][4] = SK_LOS[0]*(P[4][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[4][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[4][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[4][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[4][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[4][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[4][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[4][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[4][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][5] = SK_LOS[0]*(P[5][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[5][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[5][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[5][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[5][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[5][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[5][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[5][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[5][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][6] = SK_LOS[0]*(P[6][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[6][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[6][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[6][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[6][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[6][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[6][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[6][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[6][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][7] = SK_LOS[0]*(P[7][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[7][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[7][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[7][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[7][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[7][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[7][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[7][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[7][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][8] = SK_LOS[0]*(P[8][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[8][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[8][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[8][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[8][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[8][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[8][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[8][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[8][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][9] = SK_LOS[0]*(P[9][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[9][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[9][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[9][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[9][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[9][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[9][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[9][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[9][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][10] = SK_LOS[0]*(P[10][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[10][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[10][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[10][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[10][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[10][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[10][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[10][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[10][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][11] = SK_LOS[0]*(P[11][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[11][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[11][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[11][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[11][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[11][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[11][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[11][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[11][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][12] = SK_LOS[0]*(P[12][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[12][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[12][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[12][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[12][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[12][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[12][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[12][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[12][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][13] = SK_LOS[0]*(P[13][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[13][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[13][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[13][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[13][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[13][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[13][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[13][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[13][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][14] = SK_LOS[0]*(P[14][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[14][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[14][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[14][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[14][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[14][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[14][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[14][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[14][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][15] = SK_LOS[0]*(P[15][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[15][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[15][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[15][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[15][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[15][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[15][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[15][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[15][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][16] = SK_LOS[0]*(P[16][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[16][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[16][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[16][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[16][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[16][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[16][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[16][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[16][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][17] = SK_LOS[0]*(P[17][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[17][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[17][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[17][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[17][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[17][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[17][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[17][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[17][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][18] = SK_LOS[0]*(P[18][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[18][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[18][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[18][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[18][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[18][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[18][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[18][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[18][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][19] = SK_LOS[0]*(P[19][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[19][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[19][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[19][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[19][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[19][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[19][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[19][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[19][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][20] = SK_LOS[0]*(P[20][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[20][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[20][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[20][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[20][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[20][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[20][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[20][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[20][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            K_LOS[1][21] = SK_LOS[0]*(P[21][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[21][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[21][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[21][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[21][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[21][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[21][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[21][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[21][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            if (!inhibitGndHgtState) {
                K_LOS[1][22] = SK_LOS[0]*(P[22][0]*(SK_LOS[2] + 2*q0*SH_LOS[1]*SK_LOS[8]) + P[22][1]*(SK_LOS[5] - 2*q1*SH_LOS[1]*SK_LOS[8]) - P[22][2]*(SK_LOS[3] + 2*q2*SH_LOS[1]*SK_LOS[8]) + P[22][3]*(SK_LOS[4] + 2*q3*SH_LOS[1]*SK_LOS[8]) + P[22][5]*SH_LOS[0]*SK_LOS[8]*(2*q0*q3 + 2*q1*q2) - P[22][6]*SH_LOS[0]*SK_LOS[8]*(2*q0*q2 - 2*q1*q3) - P[22][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[22][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[4] + P[22][4]*SH_LOS[0]*SK_LOS[7]*SK_LOS[8]);
            } else {
                K_LOS[1][22] = 0.0f;
            }
            ...
            //printf("losPred.y=%5.3f, flowRadXYcomp.y=%5.3f\n", losPred[1], flowRadXYcomp[1]);
        ...
        for (uint8_t obsIndex = 0; obsIndex < 2; obsIndex++) {
            ...
            if ((innovOptFlow[obsIndex]*innovOptFlow[obsIndex]/varInnovOptFlow[obsIndex]) < 25.0f) {
                ...
                for (uint8_t i = 0; i < n_states; i++)
                {
                    ...
                    KH[i][22] = K_LOS[obsIndex][i] * H_LOS[obsIndex][22];
                }
                for (uint8_t i = 0; i < n_states; i++)
                {
                    for (uint8_t j = 0; j < n_states; j++)
...
void AttPosEKF::FocalLengthScaleFactorEKF()
{
    ...
    if (validTilt && validHeight)
    {
        ...
        // calculate Kalman gains
        K_OPT[0] = (fScaleFactorVar*SH_OPT[2]*SK_OPT[1])/fScaleFactorObsInnovVar[0];
        K_OPT[1] = (fScaleFactorVar*SH_OPT[2]*SK_OPT[0])/fScaleFactorObsInnovVar[1];
