...
void WriteFilterOutput()
{
    ...
    fprintf(pRngFuseFile," %e %e %e %e %e %e %e", _ekf->innovRng, _ekf->varInnovRng, _ekf->flowStates[1], _ekf->rngMea, _ekf->hgtMea, _ekf->flowStates[1], -_ekf->states[9] - _ekf->rngMea);
