...
% X,Y,Z Misalignment of the optical flow sensor rel to body XYZ (rad)
% X,Y bias errors on the optical flow rate sensor (rad/sec)
...
losRateX =  optRateX + (omegaSensor(1) + w1_b);
losRateY =  optRateY + (omegaSensor(2) + w2_b);

% calculate the observation jacobian
H_LOS = jacobian([losRateX;losRateY],stateVector);
